        ...
        <div className="container">
          <div className="flex flex-col gap-8 md:gap-14">
            <div className="flex flex-col items-center text-center gap-3.5">
              ...
              <p className="font-medium text-navyGray dark:text-white/80 max-w-lg">
                From expert advice to behind-the-scenes stories — explore
                content designed for curious minds.
              </p>
            </div>
