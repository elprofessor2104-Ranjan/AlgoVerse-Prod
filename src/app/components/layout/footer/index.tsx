                ...
                return (
                  <Link href={item?.link} key={index}>
                    <Image
                      ...
                      width={24}
                      height={24}
                      className="hover:opacity-70 block dark:hidden"
                    />
                    <Image
                      src={item?.dark_icon}
                      alt="social-icon"
                      width={24}
                      height={24}
                      className="hover:opacity-70 hidden dark:block"
                    />
                  </Link>
                );
              })}
              ...
              {menuData?.privacyLink?.map((item: any, index: any) => {
                ...
                return (
                  <div key={index} className="flex items-center">
                    <Link href={item?.href}>
                      <li className="text-sm text-navyGray dark:text-white/80 font-medium hover:text-primary dark:hover:text-primary">
                        {item?.name}
                      </li>
                    </Link>
                    {!isLast && (
